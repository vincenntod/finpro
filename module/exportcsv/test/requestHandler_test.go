	...
	tests := []struct {
	...
	}{
		{
			...
			makeFields: func() fields {
				...
				mockController.EXPECT().
					ExportCSV(&exportcsv.ExportCSVRequest{"", "", ""}).
		...
		},
		{
			...
			makeFields: func() fields {
				mockController := mocks.NewController(t)
				mockController.EXPECT().
					ExportCSV(&exportcsv.ExportCSVRequest{"", "2023-04-17", "2023-04-18"}).
					Return([][]string{{"id", "od_number", "status", "price", "created_at"},
						{"2241", "9860709914616572", "SUCCESS", "1000.000000", "2023-04-18"},
						{"2242", "0969598565950745", "SUCCESS", "1000.000000", "2023-04-18"},
						{"241", "5655429080696649", "WAITING_FOR_DEBITTED", "1000.000000", "2023-04-18"},
		...
		},
		{
			...
			makeFields: func() fields {
				mockController := mocks.NewController(t)
				mockController.EXPECT().
					ExportCSV(&exportcsv.ExportCSVRequest{"SUCCESS", "", ""}).
					Return([][]string{{"id", "od_number", "status", "price", "created_at"},
						{"2241", "9860709914616572", "SUCCESS", "1000.000000", "2023-04-18"},
						{"2242", "0969598565950745", "SUCCESS", "1000.000000", "2023-04-18"}},
						nil).Once()
		...
		},
		{
			...
			makeFields: func() fields {
				mockController := mocks.NewController(t)
				mockController.EXPECT().
					ExportCSV(&exportcsv.ExportCSVRequest{"SUCCESS", "2023-04-17", "2023-04-18"}).
					Return([][]string{{"id", "od_number", "status", "price", "created_at"},
						{"2241", "9860709914616572", "SUCCESS", "1000.000000", "2023-04-18"},
						{"2242", "0969598565950745", "SUCCESS", "1000.000000", "2023-04-18"}},
						nil).Once()
		...
		},
		{
			...
			makeFields: func() fields {
				mockController := mocks.NewController(t)
				mockController.EXPECT().
					ExportCSV(&exportcsv.ExportCSVRequest{"WAITING_FOR_DEBITTED", "", ""}).
					Return([][]string{{"id", "od_number", "status", "price", "created_at"},
						{"241", "5655429080696649", "WAITING_FOR_DEBITTED", "1000.000000", "2023-04-18"},
						{"242", "1262435180570130", "WAITING_FOR_DEBITTED", "1000.000000", "2023-04-18"}},
						nil).Once()
		...
		},
		{
			...
			makeFields: func() fields {
				mockController := mocks.NewController(t)
				mockController.EXPECT().
					ExportCSV(&exportcsv.ExportCSVRequest{"WAITING_FOR_DEBITTED", "2023-04-17", "2023-04-18"}).
					Return([][]string{{"id", "od_number", "status", "price", "created_at"},
						{"241", "5655429080696649", "WAITING_FOR_DEBITTED", "1000.000000", "2023-04-18"},
						{"242", "1262435180570130", "WAITING_FOR_DEBITTED", "1000.000000", "2023-04-18"}},
						nil).Once()
